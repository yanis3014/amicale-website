            ...
            <Link key={href} href={href} className="group block">
              <Card variant="default" hover className="h-full p-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-primary-100 text-primary-600 flex items-center justify-center flex-shrink-0 group-hover:bg-primary-200 transition-colors">
                    <Icon className="w-6 h-6" />
                  </div>
                  <div>
                    <h2 className="font-display font-bold text-neutral-900 text-lg group-hover:text-primary-600 transition-colors">
                      {label}
                    </h2>
                    {description && (
