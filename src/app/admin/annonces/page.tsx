    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          ...
          className="px-6 py-3 bg-primary text-white rounded-lg font-semibold hover:bg-primary-600 transition-colors flex items-center gap-2"
        >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-primary focus:outline-none">
                ...
                <option>Vie de l&apos;Amicale</option>
            ...
            <div className="flex gap-3 pt-4">
              <button className="px-6 py-2 bg-primary text-white rounded-lg font-semibold hover:bg-primary-600 transition-colors">
                Publier
              </button>
              <button
        ...
        {mockActivities.map((activity) => (
          ...
          >
            ...
            <div className="flex gap-3 pt-4 border-t border-gray-200">
              <button className="px-4 py-2 bg-primary-50 text-primary rounded-lg font-medium hover:bg-primary-100 transition-colors flex items-center gap-2">
