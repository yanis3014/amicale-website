        ...
        <section className="bg-white rounded-xl border border-neutral-200 shadow-sm p-6">
          ...
          <div className="flex flex-wrap items-center gap-4">
            {values.home_hero_image ? (
              <div className="relative w-48 h-36 rounded-xl overflow-hidden bg-neutral-100 border border-neutral-200">
                <img
              ...
              <div className="w-48 h-36 rounded-xl bg-neutral-100 border border-neutral-200 flex items-center justify-center text-neutral-400">
